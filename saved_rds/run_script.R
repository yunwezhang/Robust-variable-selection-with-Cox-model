...
load("saved_rds/simdata_highdim_outlier0.2_param2_0819.RData")
result1=result1[1:500]
result2=result2[1:500]
result3=result3[1:500]
result4=result4[1:500]
result5=result5[1:500]
save(result1,result2,result3,result4,result5,file="saved_rds/simdata_highdim_outlier0.2_param2_0819.RData")

load("saved_rds/simdata_highdim_param2_0819.RData")
result1=result1[1:500]
result2=result2[1:500]
result3=result3[1:500]
result4=result4[1:500]
result5=result5[1:500]
save(result1,result2,result3,result4,result5,file="saved_rds/simdata_highdim_param2_0819.RData")
